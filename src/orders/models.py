...
from backendGS.utils import unique_order_id_generator
...
class Order(models.Model):
    ...
    order_id = models.CharField(
        max_length=120, blank=True)  # AB31DE3
...
def post_save_order(sender, instance, created, *args, **kwargs):
    print("It's working hold on Homie!")
    if created:
        print("Damn it updating chill out...first")
